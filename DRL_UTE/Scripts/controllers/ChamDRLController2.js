var ChamDRLController2 = {
    init: function () {
        ChamDRLController2.LoadData();
        ChamDRLController2.registerEvent();
    },
        ...
        $('.txtDiem').off('keypress').on('keypress', function (e) {
            if (e.which == 13) {
                ...
                if (value >= 0 && value <= max) {
                    ...
                    ChamDRLController2.updateBangDiem(id, value);
                } else {
                ...
                if (response.status) {
                    ...
                    $.each(data, function (i, item) {
                        html += Mustache.render(template, {
                            ...
                            minhChung: item.canMinhChung == 1 ? "<img src=\"/assets/imgMC/" + item.minhChung + "\" id=\"pictureUpload\" height=\"90\" width=\"90\" alt=\"Minh chứng\"/></br><a class=\"btn btn-danger btn-sm\" id=" + item.id + " href=\"/CanBoLop/DRL2/Edit/" + item.id + "\">Upload</a>" : ""
